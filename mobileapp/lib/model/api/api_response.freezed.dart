...
abstract class $ApiResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({T? data, ErrorResponse? error});
...
class _$ApiResponseImpl<T> implements _ApiResponse<T> {
  _$ApiResponseImpl({this.data, this.error});
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>(data: $data, error: $error)';
  }
...
abstract class _ApiResponse<T> implements ApiResponse<T> {
  factory _ApiResponse({final T? data, final ErrorResponse? error}) =
      _$ApiResponseImpl<T>;
...
abstract class $ErrorResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String code, String message, dynamic detail});
}
...
class _$ErrorResponseImpl implements _ErrorResponse {
  _$ErrorResponseImpl(
      {required this.code, required this.message, required this.detail});
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, code, message, const DeepCollectionEquality().hash(detail));
...
abstract class _ErrorResponse implements ErrorResponse {
  factory _ErrorResponse(
      ...
      required final dynamic detail}) = _$ErrorResponseImpl;
